...
// have been removed to avoid CI slowdowns.
//
// To restore tests from git history:
// git log --all --full-history -- crates/prtip-scanner/src/adaptive_rate_limiter.rs
// git show <commit>:crates/prtip-scanner/src/adaptive_rate_limiter.rs | tail -n +491 > tests.rs

// Tests removed (14 tests, 279 lines) - see git history to restore
