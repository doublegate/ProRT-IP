...
|---------|-----------|----------|----------|----------------|----------|
| **IPv6 Scanning** | ✅ [UC 5](32-USER-GUIDE.md#use-case-5-ipv6-scanning) | ✅ [T4](33-TUTORIALS.md#tutorial-4-multi-protocol-scanning-ipv4--ipv6) | ✅ 8 examples | ✅ [23-IPv6](23-IPv6-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
| **Service Detection** | ✅ [UC 3](32-USER-GUIDE.md#use-case-3-service-detection) | ✅ [T3](33-TUTORIALS.md#tutorial-3-service-detection) | ✅ 12 examples | ✅ [24-SERVICE](24-SERVICE-DETECTION-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
| **Idle Scan** | ✅ [UC 19](32-USER-GUIDE.md#use-case-19-idle-scan-anonymous-scanning) | ✅ [T5](33-TUTORIALS.md#tutorial-5-stealth-scanning-techniques) | ✅ 6 examples | ✅ [25-IDLE](25-IDLE-SCAN-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
| **Rate Limiting V3** | ✅ [UC 6c](32-USER-GUIDE.md#6c-rate-limiting) | ✅ [T6](33-TUTORIALS.md#tutorial-6-large-scale-scanning) | ✅ 5 examples | ✅ [26-RATE](26-RATE-LIMITING-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
| **TLS Certificates** | ✅ [UC 13](32-USER-GUIDE.md#use-case-13-tls-certificate-analysis) | ✅ [T3](33-TUTORIALS.md#tutorial-3-service-detection) | ✅ 7 examples | ✅ [27-TLS](27-TLS-CERTIFICATE-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
| **Plugin System** | ✅ [UC 10](32-USER-GUIDE.md#use-case-10-plugin-system) | ✅ [T7](33-TUTORIALS.md#tutorial-7-plugin-development) | ✅ 4 examples | ✅ [30-PLUGIN](30-PLUGIN-SYSTEM-GUIDE.md) | ✅ rustdoc (docs.rs - not yet published) |
...
3. **API Reference** (30 min)
   ...
   - Check rustdoc: plugin module (docs.rs - not yet published)
...
- **API Documentation:**
  ...
  - Online: docs.rs/prtip-network (not yet published)
...
- **API Documentation:**
  ...
  - Online: docs.rs/prtip-scanner (not yet published)
...
- **API Documentation:**
  ...
  - Online:
    - tls_handshake (docs.rs - not yet published)
    - tls_certificate (docs.rs - not yet published)
