...
5. **Check status:** Review [10-PROJECT-STATUS.md](10-PROJECT-STATUS.md) to see what's being worked on
6. **Pick a task:** Find an unassigned task in the current sprint (Phase 1 currently)
7. **Implement with tests:** Follow [06-TESTING.md](06-TESTING.md) for TDD approach
8. **Ensure security:** Review relevant sections in [08-SECURITY.md](08-SECURITY.md)
9. **Optimize if needed:** Consult [07-PERFORMANCE.md](07-PERFORMANCE.md) for hot paths
...
|---------|------|---------|
| 1.0 | October 2025 | Initial documentation creation |
